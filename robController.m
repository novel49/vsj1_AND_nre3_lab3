...
K_p = 0*[1, 1, 1]; % Proportional gain matrix containing gains K_p1 to K_p3
K_v = 0*[1, 1, 1]; % Derivative gain matrix containing gains K_v1 to K_v3

tau = -(diag(K_p)*(Theta - Theta_ref) + diag(K_v)*(Theta_dot - Theta_dot_ref)) + G; % control input (torque)
